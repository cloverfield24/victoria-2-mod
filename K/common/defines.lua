...
country = {
	...
	GREATNESS_DAYS = 600, 	   -- how many days until country risks losing status as great nation
	BADBOY_LIMIT = 27,
	...
	MOVEMENT_RADICALISM_PASSED_REFORM_EFFECT  = -1.5,
...
diplomacy = {
	...
	SPHERE_NEIGHBOUR_BONUS_INFLUENCE_PERCENT = 0.12, -- Bonus to countries in your sphere neighbouring when influencing
	OTHER_CONTINENT_BONUS_INFLUENCE_PERCENT = -0.30, -- Bonus to neighbouring countries when influencing
	...
	INVESTMENT_INFLUENCE_DEFENSE = 0.3,	-- maximum defense factor in sphere of having invested in a country
	...
	GW_CB_CONSTRUCTION_SPEED = 0.35, -- faster CB construction against enemies while at great war
	GW_WARGOAL_JINGOISM_REQUIREMENT_MOD = 0.4, -- % deduction of required jingoists in country
	GW_WARSCORE_COST_MOD = 0.7, -- cost reduction factor on warscore needed to fulfill goal if great war
	GW_WARSCORE_COST_MOD_2 = 0.8, -- cost reduction factor on warscore needed to fulfill goal if late game great war
	...
	LARGE_POPULATION_INFLUENCE_PENALTY = -0.35,
...
pops = {
	...
	MIL_LACK_EVERYDAY_NEED = 0.15,
	MIL_HAS_EVERYDAY_NEED = -0.15,
...
ai =
{
	...
	SOLDIER_FRACTION = 0.035, -- max amount of population AI wants to be soldiers
